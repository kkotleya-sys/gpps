-- Complete migration to create all required tables
-- This ensures all tables exist even if previous migrations failed

-- Create stops table if not exists
...
-- Create bus_stop_schedules table if not exists
...
-- Create bus_profiles table if not exists
...
-- Create bus_media table if not exists
